...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--danzero-teacher-games", type=int, default=0)
    parser.add_argument("--danzero-teacher-negatives", type=int, default=8)
    parser.add_argument("--danzero-teacher-margin", type=float, default=0.2)
